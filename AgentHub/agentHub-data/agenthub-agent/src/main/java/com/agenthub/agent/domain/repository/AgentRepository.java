...
public interface AgentRepository {
    ...
    List<AgentInfo> findInfoByNameLikeWithPage(String name, int pageNum, int pageSize);
    long countByNameLike(String name);
    List<AgentInfo> findInfoByPage(int pageNum, int pageSize);
    List<AgentInfo> findInfoByStatusAndPage(AgentStatus status, int pageNum, int pageSize);
