...
public interface AgentMapper {
    ...
    List<AgentPO> selectByNameLikeWithPage(@Param("name") String name, @Param("offset") int offset, @Param("limit") int limit);
    ...
    List<AgentPO> selectByPage(@Param("offset") int offset, @Param("limit") int limit);
    List<AgentPO> selectByStatusAndPage(@Param("status") String status, @Param("offset") int offset, @Param("limit") int limit);
